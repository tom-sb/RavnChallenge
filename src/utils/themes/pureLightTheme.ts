...
const colors = {
  gradients: {
    ...
    gray1: 'linear-gradient(135deg, #F0F0F0 0%, #D9E0E8 100%)',
    gray2: 'linear-gradient(135deg, #F4F6FC 0%, #D3DAE6 100%)',
  },
  shadows: {
    success: '0px 1px 4px rgba(0, 146, 98, 0.1)  0px 3px 12px 2px rgba(0, 146, 98, 0.1)',
    error: '0px 1px 4px rgba(131, 142, 158, 0.1)  0px 3px 12px 2px rgba(131, 142, 158, 0.1)',
    info: '0px 1px 4px rgba(51, 194, 255, 0.1)  0px 3px 12px 2px rgba(51, 194, 255, 0.1)',
    primary: '0px 1px 4px rgba(6, 99, 199, 0.1)  0px 3px 12px 2px rgba(6, 99, 199, 0.1)',
    warning: '0px 1px 4px rgba(131, 142, 158, 0.1)  0px 3px 12px 2px rgba(131, 142, 158, 0.1)',
    card: '0px 1px 4px rgba(131, 142, 158, 0.1)  0px 3px 12px 2px rgba(131, 142, 158, 0.1)',
    cardSm: '0px 1px 4px rgba(131, 142, 158, 0.1)  0px 3px 12px 2px rgba(131, 142, 158, 0.1)',
    cardLg: '0px 1px 4px rgba(131, 142, 158, 0.1)  0px 3px 12px 2px rgba(131, 142, 158, 0.1)',
  },
  layout: {
    general: {
      bodyBg: '#f2f5f9',
  ...
  alpha: {
    ...
    secondary: {
      5: alpha(themeColors.secondary, 0.02),
      10: alpha(themeColors.secondary, 0.1),
      30: alpha(themeColors.secondary, 0.3),
      50: alpha(themeColors.secondary, 0.5),
...
export const PureLightTheme = createTheme({
  ...
  colors: {
    gradients: {
      ...
      gray1: colors.gradients.gray1,
      gray2: colors.gradients.gray2,
    },
    shadows: {
    ...
    MuiButton: {
      ...
      styleOverrides: {
        ...
        containedSecondary: {
          ...
          color: colors.alpha.primary[100],
        },
        textSecondary: {
      ...
      styleOverrides: {
        root: {
          ...
          '& .MuiMenuItem-root.MuiButtonBase-root:active': {
            backgroundColor: alpha(colors.primary.lighter, 0.1),
          },
  ...
  typography: {
    ...
    h4: {
      fontWeight: 600,
      fontSize: 16,
      lineHeight: 1.21, // 1.4 to pixel = 22.4px y 19.36px to rem = 1.21rem
    },
    h5: {
      fontWeight: 600,
      fontSize: 14,
